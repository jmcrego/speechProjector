...
def filter_and_group_samples(samples, tokenizer):
    ...
    for s in tqdm(samples, total=len(samples), desc="Filtering samples", unit=" sample"):
        ...
        s = {"audio_file": audio_file, "text": text, "len": len(ids)}
...
if __name__ == "__main__":
    ...
    combination2samples = filter_and_group_samples(samples, tokenizer)
