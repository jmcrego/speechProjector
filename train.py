...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_steps", type=int, default=0, help="Limit training to this many steps")
    parser.add_argument("--max_epochs", type=int, default=0, help="Limit training to this many epochs")
